...
--
-- Table structure for table `everyday_stock_simulate_buy`
--

DROP TABLE IF EXISTS `everyday_stock_simulate_buy`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `everyday_stock_simulate_buy` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ts_date` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `stock` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `DATE_STOCK_UNIQUE` (`ts_date`,`stock`)
